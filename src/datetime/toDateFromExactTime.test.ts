...
test("Instant", () => {
	expect(toDateFromExactTime(Temporal.Instant.from("2024-01-01T01:23:45.678Z"))).toStrictEqual(
		new Date("2024-01-01T01:23:45.678Z"),
	);
});

test("units smaller than millisecond", () => {
	expect(toDateFromExactTime(Temporal.Instant.from("2024-01-01T00:00:00.0009Z"))).toStrictEqual(
...
test("ZonedDateTime", () => {
	expect(
		toDateFromExactTime(Temporal.ZonedDateTime.from("2024-01-01T00:00:00+09:00[Asia/Tokyo]")),
