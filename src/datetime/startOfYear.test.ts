	...
	expect(
		startOfYear(
			Temporal.ZonedDateTime.from(
				"1922-06-30T00:00:00-07:00[America/Mexico_City]",
			),
		),
	).toEqual(
		Temporal.ZonedDateTime.from(
			"1922-01-01T00:00:00-06:36:36[America/Mexico_City]",
		),
	);
	expect(
		startOfYear(
...
test("ZonedDateTime and forward transition", () => {
	expect(
		startOfYear(
			Temporal.ZonedDateTime.from("2004-02-01T12:00:00+10:00[Asia/Khandyga]"),
		),
	).toEqual(
