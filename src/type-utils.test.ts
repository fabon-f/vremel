...
test("isZonedDateTime", () => {
	...
	expect(createTypes(Temporal1).map((v) => isZonedDateTime(v))).toEqual(
		expected,
	);
	expect(createTypes(Temporal2).map((v) => isZonedDateTime(v))).toEqual(
		expected,
	);
});
...
test("isPlainDateTime", () => {
	...
	expect(createTypes(Temporal1).map((v) => isPlainDateTime(v))).toEqual(
		expected,
	);
	expect(createTypes(Temporal2).map((v) => isPlainDateTime(v))).toEqual(
		expected,
	);
});
...
test("isPlainYearMonth", () => {
	...
	expect(createTypes(Temporal1).map((v) => isPlainYearMonth(v))).toEqual(
		expected,
	);
	expect(createTypes(Temporal2).map((v) => isPlainYearMonth(v))).toEqual(
		expected,
	);
});
...
test("isPlainMonthDay", () => {
	...
	expect(createTypes(Temporal1).map((v) => isPlainMonthDay(v))).toEqual(
		expected,
	);
...
test("getConstructor", () => {
	...
	expect(createTypes(Temporal1).map((v) => getConstructor(v))).toEqual(
		createExpected(Temporal1),
	);
	expect(createTypes(Temporal2).map((v) => getConstructor(v))).toEqual(
		createExpected(Temporal2),
	);
});
